                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="colapse">                                
                                    ...
                                    <li class=""><a href=" report_ruanganATK.php">Ruangan Dan Barang ATK</a></li>
                                    <li class=""><a href=" report_ruanganELEK.php"> Ruangan Dan Barang Elektronik</a></li>
                                </ul>
                            </li>
                        </ul>
                    </nav>
        ...
        <div class="main-content">
            <form action="" method="POST">
                ...
                <div class="main-content-inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Daftar Ruangan Beserta Barang Elektronik</h5>
                            <div class="data-tables datatable-primary">
                                <table class="table" id="dataTable">
                                    ...
                                    <tbody>
                                        <?php
                                    $sql = mysqli_query($con,"SELECT * FROM barangruang WHERE nama_ruang='Ruang Elektronik'");
