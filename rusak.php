...
@$jumlah = $_POST['jumlah'];
@$form= "?form";
@$isi = "id_rusak = '', jumlah = '$jumlah', id_inventaris='$barang', tanggal_rusak='$waktu' ";
...
if(isset($_GET['edit'])){
    ...
    $edit = $perintah->delete($con,$table,$where);
}
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class=""><a href="jenis.php">Supply</a></li>
                                    ...
                                    <li class="active"><a href="peminjaman.php">Maintenance</a></li>
                            ...
                            <li>
                                ...
                                <ul class="colapse">
                                    ...
                                    <li class=""><a href=" report_ruanganATK.php">Report Ruangan Dan Barang ATK</a></li>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="number" min="0" placeholder="Jumlah"
                                                    aria-label="Jumlah Pasokan" value="<?php echo @$edit['jumlah'] ?>"
                                                    name="jumlah" require>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" readonly type="datetime"
                                                    value="<?php  echo @$waktu?>" placeholder="Keterangan"
                            ...
                            <div class="data-tables datatable-primary">
                                <table class="table" id="dataTable">
                                    ...
                                    ?>
                                        <tr>
                                            <td></td>
                                            <td><?php echo $data['id_rusak']?></td>
                                            <td><?php echo $data['id_inventaris']?></td>
                                            <td><?php echo $data['jumlah']?></td>
                                            <td><?php echo $data['tanggal_rusak']?></td>
                                            <td>
                                                <a href="?form&edit&kode='<?php echo $data['id_rusak']?>'">Update</a>
                                            </td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
